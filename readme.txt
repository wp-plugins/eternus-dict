...
Eternus dict is plugin for simple text editing, works like a dictionary. This plugin allows you to place content anywhere on the web page, simply by adding call_key ('<?=eternus_dict('call_key')?>') into your template. Call key will be created when you enter a new word into the Eternus dict
...
1. 1-addPlugin.png
2. 2-findPlugin.png
3. 3-selectPlugin.png
4. 4-activatePlugin.png
5. 5-showdictPlugin.png
6. 6-addWord.png
7. 7-edictLookUp.png
8. 8-HowToUse.png
